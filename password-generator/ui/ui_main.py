...
"}")
        ...
        icon1 = QIcon()
        icon1.addFile(u":/icons/icons/lock.svg", QSize(), QIcon.Disabled, QIcon.Off)
...
"}")
        ...
        self.horizontalLayout_4.addWidget(self.btn_visibility)
...
"}")
        ...
        self.layout_length.addWidget(self.spinBox)
